      ...
      <div class="team_container">
        <div class="row">
          <div class="col-lg-4 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/harshit.jpg" class="img1" alt="Harshit Image" style="height:150px; width:150px;">
              </div>
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/Vishal.png" class="img1" alt="Vishal image" style="height:150px; width:150px;">
              </div>
              <div class="detail-box">
                <h5>
                  Vishal Tomar
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="box ">
              <div class="img-box">
                <img src="images/yuvraj.jpg" class="img1" alt="Yuvraj Image" style="height:150px; width:150px;">
              </div>
              <div class="detail-box">
                <h5>
                  Yuvraj Singh
